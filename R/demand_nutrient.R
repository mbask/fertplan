...
#'  * **part**, The part of interest of the crop, either `r get_available("part")`. Note that parts are specific on the crop chosen.
...
#'  * **texture**, Soil texture , either `r get_available("soil texture")`
#'  * **drainage_rate**, Rate of drainage in soil, either `r get_available("drainage")`
