...
The Nitrogen fertilization concentration in kg/ha is estimated as the net resultant of a N balance into the availability pool for the crop and out of it The N balance involves 8 flow components. flowes that increase N availability to the crop are > 0 (positive sign), flowes that deplete soil N pool or N availability for the crop are < 0 (negative sign). 
 ...
 * **Previous crop**, this is the crop present previously than the one that will be sown. Previous crop is look up in table 5 (page 24) of the *guidelines*. Previous crop contributes to **E** component. Available matches include:
  ```{r, echo = FALSE}
  knitr::kable(gsub("%", "\\\\%", fertplan:::tables_l$tab_05_dt[, crop]), escape = FALSE)
  ```
 
 * **Texture**, soil texture, one of `r levels(fertplan:::tables_l$tab_01_wdt[, soil_texture])`. Soil texture enters in several flowes of the Nitrogen balance.
