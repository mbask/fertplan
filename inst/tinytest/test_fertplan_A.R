...
expect_equal(fertplan:::rem_n_coef_of("Ribes", "Frutti"), 0.14)
expect_equal(fertplan:::rem_n_coef_of("Actinidia", "Frutti"), 0.15)
...
expect_equal(fertplan:::rem_k_coef_of("Ribes", "Frutti"), 0.44)
expect_equal(fertplan:::abs_k_coef_of(c("Ribes", "Girasole"), "Pianta"), c(1, 8.51))
expect_equal(fertplan:::rem_p_coef_of("Ribes", "Frutti"), 0.1)
...
expect_warning(fertplan:::rem_n_coef_of(c("Ribes", "Rosa purpurea del Cairo"), "Frutti"), "1 crops or parts were not matched in the appropriate guidelines table")

# Expect NA for those crop failed lookups
expect_true(is.na(fertplan:::abs_n_coef_of("Rosa purpurea del Cairo", "Pianta")))
expect_true(is.na(fertplan:::rem_n_coef_of(c("Ribes", "Rosa purpurea del Cairo"), "Frutti")[2]))
