...
Matching-variables are:
  ...
  * **Crop**, this is the name of the crop to be sown and will be used to lookup its nitrogen demand in table 15.2 (page 63) of the *guidelines* to contribute to **$f_{N,a}$** component. The name must match one of the following crop names available. Partial matching is not allowed. Note that this implemetation of the table has separated the crop column into two features, "actual crop" and "part" (eg fruits, whole plant, and so on). The allowed crop names are:
  ```{r, echo = FALSE}
