...
The N flow components include:
  ...
  * **B** Nitrogen concentration currently in the soil due to its fertility. This component sums two nitrogen pools: **b1** available nitrogen to the crop, and **b2** nitrogen supply from mineralization of organic matter
  * **C** Nitrogen leached due to precipitation during latest winter season
  ...
  * **G** Nitrogen supply from atmospheric depositions and from N-fixing bacteria
